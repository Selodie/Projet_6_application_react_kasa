...
export default function Collapse({title, text}) {
    ...
    // contient le svg de la flèche de haut
    ...
    // par défaut est à false donc la collapse est fermée
    ...
    return(
        <>
            <div className="collapse">
                ...
                <div>
                    {/* ternaire pour définir la flèche qui apparaît selon ouverture ou fermeture du bouton */}
                    {/* <span onClick={ () => setOpen (!open)}> {
                            open ? 
                                <svg className="arrowUp" xmlns="http://www.w3.org/2000/svg" width="32" height="33" viewBox="0 0 32 33" fill="none">
                            ...
                            :
                                <svg className="arrowDown" xmlns="http://www.w3.org/2000/svg" width="33" height="32" viewBox="0 0 33 32" fill="none">
                    ...
                    <span onClick={ () => setOpen (!open)}> {open === true ? arrowUp : arrowDown}
                    </span>
            ...
            {open && <p className="textCollapse">{text}</p>}
            </div>
        </>
    )
}
